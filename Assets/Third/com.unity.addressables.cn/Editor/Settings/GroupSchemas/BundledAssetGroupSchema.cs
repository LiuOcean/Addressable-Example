...
//    [CreateAssetMenu(fileName = "BundledAssetGroupSchema.asset", menuName = "Addressables/Group Schemas/Bundled Assets")]
    ...
    public class BundledAssetGroupSchema : AddressableAssetGroupSchema, IHostingServiceConfigurationProvider, ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        [SerializedTypeRestriction(type = typeof(IDataConverter))]
        [Tooltip("The type of data stream processor.  This can be provided to implement bundle encryption.")]
#pragma warning disable 0649
        SerializedType m_DataStreamProcessorType;
#pragma warning restore 0649
        /// <summary>
        /// The type of data stream processor.  This can be provided to implement bundle encryption.
        /// </summary>
        public SerializedType DataStreamProcessorType { get { return m_DataStreamProcessorType; } }
        ...
        {
            string assetBundleProviderFullName = AssetBundleProviderType.Value.FullName;
            if (DataStreamProcessorType.Value != null) {
                assetBundleProviderFullName = string.Format("{0}_{1}", assetBundleProviderFullName, DataStreamProcessorType.Value.FullName);
            }
            return ForceUniqueProvider ? string.Format("{0}_{1}", AssetBundleProviderType.Value.FullName, Group.Guid) : assetBundleProviderFullName;
        }
        ...
        GUIContent m_DataStreamProcessorContent = new GUIContent("Data Stream Processor", "The type of data stream processor.  This can be provided to implement bundle encryption.");
        ...
        void ShowAdvancedPropertiesMulti(SerializedObject so, List<AddressableAssetGroupSchema> otherBundledSchemas, ref List<Action<BundledAssetGroupSchema, BundledAssetGroupSchema>> queuedChanges)
        {
            ...
            ShowSelectedPropertyMulti(so, nameof(m_DataStreamProcessorType), m_DataStreamProcessorContent, otherBundledSchemas, ref queuedChanges, (src, dst) => { dst.m_DataStreamProcessorType = src.DataStreamProcessorType; dst.SetDirty(true); }, ref m_DataStreamProcessorType);
        }
