...
namespace UnityEditor.AddressableAssets
{
    ...
    public class AddressableAssetSettingsDefaultObject : ScriptableObject
    {
        ...
        public static void CheckEmptyGroup()
        {
            ...
            int count = LoadAll<AddressableAssetGroup>($"{kDefaultConfigFolder}/AssetGroups", out var list);
            ...
            foreach(var assetGroup in list)
            {
                Settings.groups.Add(assetGroup);
            }
        }

        private static int LoadAll<T>(string path, out List<T> assetsFound) where T : UnityEngine.Object
        {
